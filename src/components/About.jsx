  ...
  return (
    <Tilt className="xs:w-[250px] w-full">
      ...
      >
        ...
        >
          <img src={icon} alt={title} className="w-16 h-16 objext-contain" />
  ...
  return (
    <>
      ...
      >
        ...
        expertise in frameworks like React and Three.js. I am also a graphic
        designer with a creative mindset. I'm a quick learner and collaborate
